...
function DateTextField(props) {
    ...
    return (
        ...
        <Stack direction="column" spacing={0} justifyContent='space-between' alignItems={'left'} sx = {{marginLeft: "0px", '& .MuiOutlinedInput-root' : {width:'300px', m: 1, paddingRight: "10px"} }}>
